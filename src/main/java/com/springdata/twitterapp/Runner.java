...
//        System.out.println("ALL COMMENTS BY TWEET" + commentService.findAllByTweet(editedTweet));
//        System.out.println("ALL COMMENTS BY TWEET" + commentService.findAllByUser(editedUser));



        //TESTING DELETE OPERATIONS
        //Tweet foundTweet =tweetService.findByText("text1"); //am mutat la 35
        //userService.removeTweetFromUser(tweet, editedUser);
      /*  tweetService.deleteAllCommentsFromTweets(editedTweet);
        userService.deleteAllTweetsFromUser(editedUser);
        userService.deleteUser(editedUser); //se sterge tot ;*/
